...
export default function WardRiskMapPage() {
  ...
  const reports24h = reports.filter((r) => new Date(r.timestamp).getTime() > last24Hours)
  const reports7d = reports.filter((r) => new Date(r.timestamp).getTime() > last7Days)

  // NEW: get selected district name
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 p-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Delhi Ward Risk Map</h1>
            ...
            <Card>
              ...
              <CardContent>
                ...
                >
                  ...
                  <h3 className="mb-2 text-2xl font-bold">{wardData.name}</h3>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-bold">{wardData.riskScore}/100</h3>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Reports (24h)</p>
                      <h3 className="text-2xl font-bold">{reports24h.length}</h3>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Reports (7d)</p>
                      <h3 className="text-2xl font-bold">{reports7d.length}</h3>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <Card>
            <CardContent className="flex min-h-[400px] items-center justify-center p-12 text-center">
              <div>
                ...
                <h3 className="mb-2 text-lg font-medium">Select a Ward to View</h3>
                <p className="text-muted-foreground">
